...
<html>
    ...
    <body>
        ...
        <div class="alert alert-warning alert-dismissible fade show w-25 mx-auto" 
             role="alert">
                                ...
                                <div class="row justify-content-around p-1">
                                    <div class="col-md-5">
                                        ...
                                        <input type="text" name="referencia" 
                                               ...
                                               required <c:if test="${asiento.estado == 'cerrado'}">disabled</c:if>>
                                            <div class="invalid-feedback">
                                            ...
                                            <textarea name="observaciones" 
                                                      ...
                                                      rows="3" maxlength="60" 
                                                      style="resize: none;" 
                                                      placeholder="Maximo 60 caracteres" <c:if test="${asiento.estado == 'cerrado'}">disabled</c:if>>${asiento.observaciones}</textarea>
                                        </div>
                                        <div class="col-md-5">
                                            ...
                                            <input name="fecha" type="date" 
                                                   class="form-control mb-2" 
                                                   id="fecha" value="${asiento.fecha}" required <c:if test="${asiento.estado == 'cerrado'}">disabled</c:if>>
                                            <div class="invalid-feedback">
                                            ...
                                            <input name="fechaCierre" type="date" 
                                                   class="form-control mb-2" 
                                                   id="fechaCierre" 
                                                   value="${asiento.fechaCierre}" required <c:if test="${asiento.estado == 'cerrado'}">disabled</c:if>>
                                            <div class="invalid-feedback">
                                                Seleccione la fecha de cierre
                                            </div>

                                            <label for="diario" class="form-label">
                                                Diario
                                            </label>
                                            <select name="diario" 
                                                    class="form-select mb-4" 
                                                    id="diario" 
                                                    aria-label="Default select example" <c:if test="${asiento.estado == 'cerrado'}">disabled</c:if>>
